---
title: Introduction
description: Welcome to the Nuxt CRUD documentation.
navigation:
  icon: i-lucide-house
seo:
  title: Introduction
...
- **cli**: A command-line interface for generating Laravel-like endpoints, as well as request and response schemas to speed up your development workflow.
- **module**: An admin panel that is automatically generated from your Drizzle ORM models, providing a ready-to-use interface for managing your data.

These tools work together to help you quickly scaffold and manage CRUD operations in your application.
